...
def run_code(start, end):
    for Model_id in range(start, end+1):
        ...
        #Plate material
        EPlate = 20_000_000 # to 50_000_000 kN/m^2#esko value kati hunxa?
        ...
        Gref= (EA/d)/(2*(1+nu))
        plat_mat=g_i.platemat('MaterialName','Facing_1','nu',0.25,'w',0.6,'IsIsotropic',True,'EA',EA,'EA2',EA,'EI',EI,'d',d,'Gref',Gref)
        ...
        ENail = 200_000_000
        TensionPullOut = 25#esko value kati hunxa?
        ...
        emrow.setproperties('Diameter',0.02)
